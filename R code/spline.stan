data{
  ...
  matrix[n1, num_basis] B1; 
  matrix[n2, num_basis] B2; 
  matrix[n2, num_basis] Bd2; 
...
transformed parameters{
  ...
  vector[n2]  y21=csr_matrix_times_vector(n2, num_basis, w2, v2, u2, a )+a0;       // B2*a + a0; 
  vector[n1]  y1_hat= csr_matrix_times_vector(n1, num_basis, w1, v1, u1, a )+a0;       // B1*a + a0;
  {
